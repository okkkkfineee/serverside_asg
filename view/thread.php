...
$threadId = $_GET['id'] ?? null; // Ensure threadId is set
  ...
  <div class="container mt-5">
    <div class="thread-container">
      ...
      <div class="replies">
        ...
        <div class="reply">
            <p><strong>User <?= htmlspecialchars($post['user_id']) ?>:</strong> <?= htmlspecialchars($post['content']) ?></p>
        </div>
        <?php endforeach; ?>
      </div>
      ...
      <div class="reply-form">
        ...
        <form action="../controller/forum_controller.php?action=createPost" method="POST">
