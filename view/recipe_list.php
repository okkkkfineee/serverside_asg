                    ...
                    <?php else : ?>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 col-xl-3 d-flex justify-content-center mb-4">
                            <div class="card border shadow-sm" style="width: 100%; max-width: 20rem; height: 100%;">
                                <img src="../uploads/recipe/<?php echo $recipe['images'] ?? 'default_recipe.png'; ?>" class="card-img-top rounded-top" alt="Recipe Image" style="width: 100%; height: 200px; object-fit: cover;">
